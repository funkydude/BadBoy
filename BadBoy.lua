...
local instantReportList = {
	...
	--[[  Guild Buy/Sell  ]]--
	--{star}{star}WTB Level 25 Guild, Paying Good {star} EVEN if its DEAD! {star} Buying from a different severs too ! {star}{star} Also buying 20 Guild + {star} 10 + Guilds too {star}
